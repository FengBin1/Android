    ...
    private void init() {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MyBroadcastReceiverTwo receiver2 = new MyBroadcastReceiverTwo();
                MyBroadcastReceiverOne receiver3 = new MyBroadcastReceiverOne();
                sendOrderedBroadcast(intent,null,receiver3, null, 0, null, null); // 发送有序广播
            }
        });
    }
